				...
				<div className="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form>
						...
						<div className="bor8 m-b-20 how-pos4-parent">
							...
							<img className="how-pos4 pointer-none" src="https://portfoliosinharaj2005.netlify.app/assets/images/icons/icon-email.png" alt="ICON" />
						</div>
						...
						<button className="flex-c-m stext-101 cl0 size-121 bg3new bor1 hov-btn3 p-lr-15 trans-04 pointer">
							Submit
						</button>
					</form>
				</div>
					...
					<div className="flex-w w-full p-b-42">
						...
						<div className="size-212 p-t-2">
							...
							<p className="stext-115 cl6 size-213 p-t-18">
								Any questions? Let us know in Whatsapp Number (+91) 9873955466
							</p>
						</div>
					</div>
					...
					<div className="flex-w w-full p-b-42">
						...
						<div className="size-212 p-t-2">
							...
							<p className="stext-115 cl1 size-213 p-t-18">
								Whatsapp Number <a href="tel:9873955466">(+91)9873955466</a>
							</p>
						</div>
					</div>
